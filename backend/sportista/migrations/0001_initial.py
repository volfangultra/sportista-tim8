    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monday_start', models.TimeField(default=datetime.time(0, 0))),
                ('monday_end', models.TimeField(default=datetime.time(0, 0))),
                ('tuesday_start', models.TimeField(default=datetime.time(0, 0))),
                ('tuesday_end', models.TimeField(default=datetime.time(0, 0))),
                ('wednesday_start', models.TimeField(default=datetime.time(0, 0))),
                ('wednesday_end', models.TimeField(default=datetime.time(0, 0))),
                ('thursday_start', models.TimeField(default=datetime.time(0, 0))),
                ('thursday_end', models.TimeField(default=datetime.time(0, 0))),
                ('friday_start', models.TimeField(default=datetime.time(0, 0))),
                ('friday_end', models.TimeField(default=datetime.time(0, 0))),
                ('saturday_start', models.TimeField(default=datetime.time(0, 0))),
                ('saturday_end', models.TimeField(default=datetime.time(0, 0))),
